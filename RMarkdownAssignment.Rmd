...
Create a new section with the title "Your work here", and beneath it, do the following 3 things. To turn this in, make sure you've committed and pushed, and turn in the link to this repository to the assignment on Blackboard.  
...
Note that you can click "Knit" as you go along to see what the final results are going to look like. **Once you're done, remember to commit the changes and push the repo back to your assignment on GitHub!**
